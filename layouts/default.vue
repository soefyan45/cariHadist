<template>
  <div class="flex flex-col leading-normal text-gray-800 min-h-screen md:mx-auto md:w-full">
    <Header />
    <main class="flex-grow m-5 mb-10 min-h-screen md:mx-auto md:w-full lg:w-2/4 pt-2">
    <nuxt/>
    </main>
    <footer class="m-5 text-s flex justify-between items-center">
      <div>
        2020 carihadist
      </div>
      <div class="flex">
        <a href="https://twitter.com/soefyan45" target="_blank">
        ...
        <a href="https://github.com/soefyan45" target="_blank">
          <svg class="h-6 w-6 mr-2 fill-current text-gray-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
        ...
        <a href="https://www.linkedin.com/in/selamet-sofyan-b88253b2" target="_blank">
          <svg class="h-6 w-6 mr-2 fill-current text-gray-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
        ...
        <a href="mailto:soefyan45@gmail.com" target="_blank">
